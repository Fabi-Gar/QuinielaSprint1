...
namespace QuinielaSprint1.Botones
{
    public class RJDatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = Properties.Resources.CalendarioIconoBlanco;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = Properties.Resources.CalendarioIcono;
                else calendarIcon = Properties.Resources.CalendarioIconoBlanco;
                this.Invalidate();
            }
        }
